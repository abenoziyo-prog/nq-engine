...
Account **DUQ794374** (IBKR paper) · MNQU6 (MNQ Sep 2026) · $2/pt · NetLiq $1000580.00  
Source: IB broker execution record (authoritative), via `trade_log.py`.  
_Updated 2026-06-24 16:17 UTC. Paper P&L flatters real (optimistic fills + delayed data)._
